...
class TopicController extends Controller
{
    ...
    public function update(Request $request, Topic $topic)
    {
        ...
        // Handle uploads (keep old files if no new upload)
        $imagePath = $request->file('image') ? $request->file('image')->store('images', 'public') : $topic->image;
        $videoPath = $request->file('video') ? $request->file('video')->store('videos', 'public') : $topic->video;
        $audioPath = $request->file('audio') ? $request->file('audio')->store('audios', 'public') : $topic->audio;
